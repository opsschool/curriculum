...
============== ====================================================
char(n)	       Fixed width character string, can hold letters and numbers. Maximum 8,000 characters
varchar(n)     Variable width character string, can hold letters and numbers. Maximum 8,000 characters
text	       Variable width character string. Value is represented internally by a separately allocated object. This is in contrast to all other data types
