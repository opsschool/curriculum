...
Examples are, quite literally, everywhere - a very limited set of example set includes ``google.com`` and ``wikipedia.org``.
...
ICANN controls the TLDs, and delegate responsibility for the registration and maintenance of specific domains to registrars.
